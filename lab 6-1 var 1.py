...
# Функция для генерации комбинаций (алгоритмический подход)
...
meetings = generate_combinations(all_employees, n)
end_time = time.time()

# Вывод результатов
print(f"\nВсего возможных вариантов совещания: {len(meetings)}")
print(f"Время выполнения (алгоритмический подход): {end_time - start_time:.6f} сек")

# Вывод первых 10 вариантов для примера
print("\nПервые 10 вариантов:")
